...
coco2014_dataset = dataset_base.copy({
    ...
    'train_info': '/data/coco-1/annotations/instances_train2014.json',
    'valid_info': '/data/coco-1/annotations/instances_val2014.json',
...
coco2017_dataset = dataset_base.copy({
    ...
    'train_info': '/data/coco-1/annotations/instances_train2017.json',
    'valid_info': '/data/coco-1/annotations/instances_val2017.json',
...
coco2017_testdev_dataset = dataset_base.copy({
    ...
    'valid_info': '/data/coco-1/annotations/image_info_test-dev2017.json',
    'has_gt': False,

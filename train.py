...
parser.add_argument('--save_folder', default='output/weights/',
                    help='Directory for saving checkpoint models.')
parser.add_argument('--log_folder', default='output/logs/',
...
def train():
    ...
    if args.resume is not None:
        ...
        yolact_net.init_weights(backbone_path=join('weights', cfg.backbone.path))
    ...
    try:
        for epoch in range(args.epochs):
            ...
            for datum in data_loader:
                ...
                iteration += 1
                if iteration % args.steps_per_epoch == 0:
                    break
